<?php
  ...
  //  include "session_timeout.php";
    ...
    $sql_pin = "SELECT * FROM Users WHERE cust_id=".$id." AND pin='".$pin."'";
...
<body>
    <div class="flex-container">
        ...
        <div class="flex-item">
            <a href="http://localhost/online-banking-system-master/net-banking/atm_simulator.php" class="button">Go Back</a>
        </div>
    </div>
