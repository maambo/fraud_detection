            ...
            <div class="flex-item-search-bar" id="fi-search-bar">
                ...
                <div class="flex-item-search-by">
                    <select name="by" onChange="window.location.href=this.value">
                        ...
                        <option value="Users_transactions.php?sort=tid_down">Tn. ID &darr;</option>
                        <option value="Users_transactions.php?sort=tid_up">Tn. ID &uarr;</option>
                        <option value="Users_transactions.php?sort=date_down">Date &darr;</option>
                        <option value="Users_transactions.php?sort=date_up">Date &uarr;</option>
                    </select>
                </div>
