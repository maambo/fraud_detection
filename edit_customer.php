<?php
   ...
   // include "session_timeout.php";
    ...
    $sql0 = "SELECT * FROM Users WHERE cust_id=".$_SESSION['cust_id'];
...
<body>
    <form class="add_Users_form" action="edit_Users_action.php" method="post">
        <div class="flex-container-form_header">
            <h1 id="form_header">Edit/View Users details . . .</h1>
        </div>

        <div class="flex-container">
            <div class=container>
                <label>Users ID : <label id="info_label"> <?php echo $_SESSION['cust_id'] ?> </label></label>
            </div>
        </div>
        ...
        <div class="flex-container">
            <div class=container>
                <label>Balance (ZMW) : <label id="info_label"> <?php echo number_format($balance) ?> </label></label>
            </div>
        </div>
        ...
        <div class="flex-container">
            <div class=container>
                ...
                <input name="nrc_no" size="25" type="text" value="<?php echo $nrc_no ?>" required />
            </div>
        </div>
        ...
        <div class="flex-container">
            ...
            <div  class=container>
                <select name="branch">
                    <option value="Lusaka" <?php if ($branch == 'Lusaka') {?> selected="selected" <?php }?>>Lusaka</option>
                    <option value="Kitwe" <?php if ($branch == 'Kitwe') {?> selected="selected" <?php }?>>Kitwe</option>
                    <option value="Ndola" <?php if ($branch == 'Ndola') {?> selected="selected" <?php }?>>Ndola</option>
