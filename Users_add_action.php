    ...
    <div class="flex-container">
        <div class="flex-item">
            ...
            if (($conn->query($sql3) === TRUE)) { ?>
                <p id="info"><?php echo "Users created successfully !\n"; ?></p>
        </div>
        ...
        <div class="flex-item">
            <a href="http://localhost/online-banking-system-master/net-banking/Users_add.php" class="button">Add Again</a>
        </div>
