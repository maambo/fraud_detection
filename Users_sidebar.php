...
<body>
    <div class="sidenav" id="theSideNav">
        ...
        <a href="http://localhost/online-banking-system-master/net-banking/Users_home.php">Home</a>
        <a href="http://localhost/online-banking-system-master/net-banking/Users_transactions.php">My
            Transactions</a>
        <a id="label">Send/Recieve</a>
        <a href="http://localhost/online-banking-system-master/net-banking/beneficiary.php">Transfer Funds</a>
        <a href="http://localhost/online-banking-system-master/net-banking/atm_simulator.php">ATM Simulator</a>
