<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($by == "name") {
            $sql0 = "SELECT cust_id, first_name, last_name, account_no FROM Users
                    ...
                    <div class="flex-item-1">
                        <div class="dropdown">
                          ...
                          <div id="dropdown<?php echo $i ?>" class="dropdown-content">
                            ...
                            <a href="http://localhost/online-banking-system-master/net-banking/edit_Users.php?cust_id=<?php echo $row["cust_id"] ?>">View / Edit</a>
                            <a href="http://localhost/online-banking-system-master/net-banking/transactions.php?cust_id=<?php echo $row["cust_id"] ?>">Transactions</a>
                            <a href="http://localhost/online-banking-system-master/net-banking/delete_Users.php?cust_id=<?php echo $row["cust_id"] ?>"
