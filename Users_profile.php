...
<body>
    <form class="add_Users_form" action="Users_profile_action.php" method="post">
        ...
        <div class="flex-container">
            <div class=container>
                <label>NRC No : <label id="info_label"><?php echo $nrc_no ?></label></label>
            </div>
        </div>
        ...
        <div class="flex-container">
            <div class=container>
                <label>Bank Branch :
                    <label id="info_label">
                        <?php
                            if ($branch == "Lusaka") {echo "Lusaka";}
                            elseif ($branch == "Kitwe") {echo "Kitwe";}
                            elseif ($branch == "Ndola") {echo "Ndola";}
        ...
        <div class="flex-container">
            <div class="container">
                <a href="/Users_home.php" class="button">Home</a>
            </div>
            <div class="container">
