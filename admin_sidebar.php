...
<body>
    <div class="sidenav" id="theSideNav">
        ...
        <a href="http://localhost/online-banking-system-master/net-banking/admin_home.php">Home</a>
        <a id="label">My Users</a>
        <a href="http://localhost/online-banking-system-master/net-banking/Users_add.php">Add Users</a>
        <a href="http://localhost/online-banking-system-master/net-banking/manage_Users.php">Manage Users</a>
        <a href="#h">Users Griveances</a>
        <a id="label">Website Management</a>
        <a href="http://localhost/online-banking-system-master/net-banking/post_news.php">Post News</a>
    </div>
