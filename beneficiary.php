...
<body>
    <div class="search-bar-wrapper">
        <div class="search-bar" id="the-search-bar">
            <div class="flex-item-search-bar" id="fi-search-bar">
                <a class="add-button" href="http://localhost/online-banking-system-master/net-banking/add_beneficiary.php">Add</a>
    ...
    <div class="flex-container">
        <p id="info">Send to, Add/Delete Receivers.</p>
        <?php
            ...
            while($row = $result->fetch_assoc()) {
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if ($by == "name") {
                        $sql1 = "SELECT cust_id, first_name, last_name, account_no FROM Users
                    ...
                    $sql1 = "SELECT cust_id, first_name, last_name, account_no
                             FROM Users WHERE cust_id=".$row["benef_cust_id"];
                }
                        ...
                        <div class="flex-item-1">
                            <div class="dropdown">
                              ...
                              <div id="dropdown<?php echo $i ?>" class="dropdown-content">
                                <!--Pass the Users trans_id as a get variable in the link-->
                                <a href="http://localhost/online-banking-system-master/net-banking/send_funds.php?cust_id=<?php echo $row1["cust_id"] ?>">Send</a>
                                <a href="http://localhost/online-banking-system-master/net-banking/delete_beneficiary.php?cust_id=<?php echo $row1["cust_id"] ?>"
